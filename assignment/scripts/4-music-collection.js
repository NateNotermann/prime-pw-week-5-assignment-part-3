...
function addToCollection ( collectionVariable, titleName, artistName, yearPublishedName ) {
    // collectionVariable=[];
    let newAlbum ={
        title: titleName,
        artist: artistName,
    ...
    // newAlbum.push(yearPublished)//adding "yearPublished' to array
    // collectionVariable = collectionVariable.push(newAlbum);
    collectionVariable.push(newAlbum);
    console.log('adding new album:', newAlbum);

    return newAlbum; //returning the NewObject as the result
}
addToCollection(collection, 'Its Blitz!', 'Yeah Yeah Yeahs', '2009');
// //called the function, specified "collection" as the array to use, added title, artist, yearpub
addToCollection(collection, 'Dreamland', 'Glass Animals', '2020' )
addToCollection(collection, 'Life of Pablo', 'Kanye', '2016' )
addToCollection(collection, 'Youre a Woman, Im a Machine', 'Death from Above 1979', '2004' )
addToCollection(collection, 'Walking on a Dream', 'Empire of the Sun', '2008' )
addToCollection(collection, 'Take off your pants and jacket', 'blink 182 ', '2001' )
addToCollection(collection, 'Enema of the State', 'blink 182 ', '1999' )
addToCollection(collection, 'All killer no filler songs', 'sum 41  ', '2001' )
